...
def search_data_assets(
    query: Annotated[str, Field(description="Search query for finding tables, columns, charts, dashboards")],
    ...
    return call_tool("search_data_assets", {"query": query, "page": page, "truncate_length": truncate_length})


def search_documentation(
    query: Annotated[str, Field(description="Search query for finding documents, questions, glossary terms")],
    page: Annotated[float, Field(ge=1, description="Page number for pagination")] = 1,
    truncate_length: Annotated[Optional[float], Field(ge=1, description="Maximum characters for text fields in results")] = 150
) -> str:
    """
    ...
    return call_tool("search_documentation", {"query": query, "page": page, "truncate_length": truncate_length})
